...
This project is licensed under AGPL-3.0. Metrics and results were generated using YOLO11 by Ultralytics (AGPL-3.0). Full source code and license details are available in the [GitHub Repository](https://github.com/alexander-lm/PestNeuroVision).\
